...
<html>
<head>
<title>前端-活動的報名狀況 - listAllActRegistersByActNo.jsp</title>
...
<p style="text-align:right; margin-right:50px; color:orange;">目前位置：<a href="<%=request.getContextPath()%>/iPETCares.jsp">首頁</a>>><a href="<%=request.getContextPath()%>/front/act/listAllAct.jsp">所有活動資訊</a>
 >><a href="<%=request.getContextPath()%>/front/actRegister/listAllActRegistersByActNo.jsp">報名狀況</a></p>
...
<!-- 		<th>付費狀態</th> -->
	...
	<c:forEach var="actRegVO" items="${allActRegsByActNo}" >
