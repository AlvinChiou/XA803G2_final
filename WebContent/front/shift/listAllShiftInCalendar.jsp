...
<p style="text-align:right; margin-right:120px; color:orange;">目前位置：<a href="<%=request.getContextPath()%>/iPETCares.jsp">首頁</a>>><a href="<%=request.getContextPath()%>/front/shift/listAllShiftInCalendar.jsp">我要掛號</a></p>
		
	<a href = "<%=request.getContextPath()%>/front/shift/listAllShiftInCalendar.jsp" style="margin-left:105px;">重新整理</a>
	<table border=0 cellpadding=0 cellspacing=0 width="80%" align="center">  
	  <tr>
	    <td>  
<!--          <font color=blue>●</font><font><b>歡迎進入: 本院掛號系統【有 <img src="images/foot.gif" border="0" height="22">記號者 】 , <font color=blue>休假</font>系統</b></font>              -->
       </td>               
	  </tr>               
    </table> 
...
calendar += "<th bgcolor='black'>   <a href='javascript:open_all(\"noteListMonth.jsp\");'><font color='lightblue'>" + year + "-" + cmon[mo] + "月所有看診時間</font></a></th>\n";
