...
<jsp:useBean id="list" scope="request" type="java.util.Set" />
...
<br>
<p style="text-align:right; margin-right:50px; color:orange;">目前位置：<a href="<%=request.getContextPath()%>/iPETCares.jsp">首頁</a>>><a href="<%=request.getContextPath()%>/front/lost/listLost_ByState.jsp">所有失蹤協尋文章</a></p>
...
<!-- 		<th nowrap>文章內容</th> -->
	...
	<c:forEach var="lostVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		<tr valign='middle' ${(lostVO.lostno == param.lostno)? 'bgcolor=#CCCCFF' : ''}><!--將修改的那一筆加入對比色而已-->
		<td>${lostVO.lostno}</td>
