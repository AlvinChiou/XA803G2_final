...
<BODY bgcolor=#dbeaf5 vLink=#0033cc background="images/wall_4.gif">
	<a href = "<%=request.getContextPath()%>/shift/listAllShiftInCalendar.jsp">重新整理</a>
...
if(mo1<10) mo2='0'+mo1;
  ...
  if ( (i - (startday - 1)) == dt && currentmonth == mo && currentyear == year) {
    ...
    calendar += "<iframe src=\"JSTL01_query4_Index_forEach_param2.jsp?shiftDate=" + year + "-" + mo2 + "-" + count2 +  "\" width=100% height=50 scrolling=no frameborder=1 ></iframe>";
    ...
    if (currentmonth == mo && currentyear == year && document.cookie) {
      ...
      if (isremind) { calendar += "<img src='images/foot.gif' border=0 height='22'>"; }
    }
    calendar += "<br/><a href = '<%=request.getContextPath()%>/shift/addShift.jsp?shiftDate="+ year + '-' + mo2 + '-' + count2 + " '>新增</a>";
