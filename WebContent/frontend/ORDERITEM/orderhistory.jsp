...
<script language="JavaScript" src="<%= request.getContextPath()%>/js/jquery-1.8.3.min.js"></script>  
		...
		<div id="main_bg">
    		<div id="main_bg01">
        		...
        		<c:if test="${memVO != null}"><%@ include file="/loginHeader.jsp" %></c:if>
				 <%@ include file="/ad.jsp" %>
				<%@ include file="/frontend/ORDERITEM/orderhistory_original.jsp" %>   
