...
<%--  <c:set var="string2" value="${fn:substring(row[0], 5, 15)}" /> --%>
  ...
  <br/>
   ...
   <nobr>
       ...
       <a href="#"  onclick="window.open('<%=request.getContextPath()%>/backend/shift/JSTL01_query4_Index_forEach_param2.jsp?shiftDate=${row[0]}', 'xxx', config='height=500,width=500');" >
