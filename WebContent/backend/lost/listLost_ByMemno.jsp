...
%>
<jsp:useBean id="listLost_ByMemno" scope="request" type="java.util.Set" />
...
<table border='1' cellpadding='5' cellspacing='0' width='700'>
	<tr bgcolor='#CCCCFF' align='center' valign='middle' height='20'>
		<td>
		<h3>失蹤協尋資料</h3>
		<a href="<%=request.getContextPath()%>/front/lost/select_page.jsp"><img src="<%=request.getContextPath()%>/backend/lost/images/back1.gif" width="100" height="32" border="0">回首頁</a>
		</td>
	</tr>
</table>
