...
<%-- <%@ include file="/menu1.jsp" %>  --%>
	<a href = "<%=request.getContextPath()%>/index.jsp">回首頁</a><br>
	<a href = "<%=request.getContextPath()%>/backend/shift-Knifeman.jsp">重新整理</a>
...
var calendar = "";
calendar =  "<table bgcolor='#666666' width='80%' border=1 bordercolor=blue cellpadding=0 cellspacing=0>\n";
...
calendar += "<th bgcolor='navy'>   <a href='javascript:open_all(\"noteListMonth.jsp\");'><font color='#ffffff'>" + year + "-" + cmon[mo] + "月所有看診時間</font></a></th>\n";
...
if(mo1<10) mo2='0'+mo1;
  ...
  if ( (i - (startday - 1)) == dt && currentmonth == mo && currentyear == year) {
    ...
    calendar += "<iframe src=\"shift/JSTL01_query4_Index_forEach_param2.jsp?shiftDate=" + year + "-" + mo2 + "-" + count2 +  "\" width=100% height=110 scrolling=no frameborder=1 ></iframe>";
    calendar += "<a href='javascript:open_window(\"shift/JSTL01_query4_Index_forEach_param2.jsp?shiftDate=" + year + "-" + mo2 + "-" + count2 + "\");'><font color='#ff0000'>" + count + "</font>";  
    //原來行事曆的連結仍然可用
    ...
    calendar += " bgcolor='#eeeeee'>";    
      calendar += "<iframe src=\"shift/JSTL01_query4_Index_forEach_param2.jsp?shiftDate=" + year + "-" + mo2 + "-" + count2 +  "\" width=100% height=110 scrolling=no frameborder=1 ></iframe>";
      calendar += "<a href='javascript:open_window(\"shift/JSTL01_query4_Index_forEach_param2.jsp?shiftDate=" + year + "-" + mo2 + "-" + count2 + "\");'><font color='#000000'>" + count + "</font>"; 
    //原來行事曆的連結仍然可用
...
function backup() {
  ...
  document.location="shift-Knifeman.jsp";
}
