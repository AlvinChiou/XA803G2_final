...
<div id="top_bg01">
	<div class="top_member_box"> 
		...
		<tbody>
		<tr>
			<td width="70" align="left" class="p11_5a8b7c">
			<a href="#"></a><br>
			</td>
							
			<td width="70" align="left" class="p11_5a8b7c">
			<a href="<%= request.getContextPath()%>/empLogin.jsp">員工登入</a><br>
			</td>
		</tr>
		<tr>
			<td width="70" align="left" class="p11_5a8b7c">
			<a href="<%= request.getContextPath()%>/memLogin.jsp">會員登入</a><br>
			</td>
							
			<td width="70" align="left" class="p11_5a8b7c">
			<a href="<%= request.getContextPath()%>/front/mem/beforeAddMem.jsp">加入會員</a><br>
			</td>
		</tr>
