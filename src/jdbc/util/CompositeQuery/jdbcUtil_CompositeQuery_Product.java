...
public class jdbcUtil_CompositeQuery_Product {
	...
	public static String get_aCondition_For_Oracle(String columnName, String value) {
		...
		if ("prono".equals(columnName) || "status".equals(columnName)||"price".equals(columnName)) // 用於其他
			aCondition = columnName + "=" + value;
		else if ("productname".equals(columnName) || "category".equals(columnName) || "keyword".equals(columnName)) // 用於varchar
