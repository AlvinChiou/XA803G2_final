		...
		if ("getOne_For_Display".equals(action)) { // 來自select_page.jsp的請求
			...
			try {
				...
				if (!errorMsgs.isEmpty()) {
					RequestDispatcher failureView = req.getRequestDispatcher("/front/news/select_page.jsp");
				...
				String url = "/front/news/listOneNews.jsp";
			...
			try{
				...
				if(!errorMsgs.isEmpty()){
					RequestDispatcher failureView = req
							.getRequestDispatcher("/front/news/select_page.jsp");
					failureView.forward(req, res);
					return;//程式中斷
				}
				...
				String url = "/front/news/listNews_Bytype.jsp";
...
//			try {
				...
				/*************************** 2.開始修改資料 *****************************************/
				// NewsService newsSvc = new NewsService();
				newsVO = newsSvc.updateNews(newsno, newstitle, newstype,
						 newscontent, buffer, newspotime, empno);
