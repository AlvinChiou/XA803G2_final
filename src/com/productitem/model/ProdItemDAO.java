...
public class ProdItemDAO implements ProdItemDAO_interface{
	...
	private static final String GET_ONE_STMT = "SELECT itemno, itemqty, itemmemo, ordno, prono, price FROM Prod_Item WHERE ordno = ?";
	 ...
	 */
	@Override
	public ProdItemVO findByPrimaryKey(String ordno) {
