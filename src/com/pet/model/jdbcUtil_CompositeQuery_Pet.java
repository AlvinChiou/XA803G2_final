...
public class jdbcUtil_CompositeQuery_Pet {
	...
	public static String get_aCondition_For_Oracle(String columnName, String value) {
		...
		if ("petNo".equals(columnName) || "petPic".equals(columnName) || "petAge".equals(columnName) || "memNo".equals(columnName)) // 用於其他
			aCondition = columnName + "=" + value;
		if ("petName".equals(columnName) || "petSex".equals(columnName) ||  "petType".equals(columnName)) // 用於varchar
