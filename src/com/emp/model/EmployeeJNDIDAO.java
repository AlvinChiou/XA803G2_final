...
import com.emp.model.EmployeeJNDIDAO;
...
public class EmployeeJNDIDAO implements EmployeeDAO_interface {
	...
	private static final String INSERT_STMT = "INSERT INTO EMPLOYEE (empNo, empName, empBirth, empTel, empSex, empPos, empSalary, empArrDate, empOff, empID, empAdd, empPic, empPassword, empEMail) VALUES (employee_seq.NEXTVAL, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	private static final String GET_ALL_STMT = "SELECT empNo, empName, empBirth, empTel, empSex, empPos, empSalary, empArrDate, empOff,empID, empAdd, empPic, empPassword, empEMail FROM EMPLOYEE order by empNo";
